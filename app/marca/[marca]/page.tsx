...
import ProductOfferCardInfo from "../../../components/ProductOfferCardInfo";
...
function buildMarcaHref(
  ...
  return `/marca/${encodeURIComponent(
    marca
  )}${query ? `?${query}` : ""}`;
}
...
export default async function MarcaPage({
  ...
  const marcaDecodificada =
    decodeURIComponent(marca);
  ...
  const resultado =
    await getPublicProductsByBrand({
      marcaVehiculo:
        marcaDecodificada,
      ...
      <main className="brand-collection-shell">
        ...
        <header className="brand-collection-header">
          <div>
            ...
            <p>
              Consulte repuestos
              disponibles por sistema.
              Filtre por categoría para
              encontrar más rápido lo que
              necesita.
            </p>
          </div>
        ...
        <div className="brand-collection-layout">
          ...
          <aside className="brand-sidebar">
            ...
            <section className="brand-sidebar-card brand-help-card">
              <h3>
                ¿No encuentra el repuesto?
              </h3>

              <p>
                Escríbanos con el modelo,
                año y código OEM para
                ayudarle a validar la
                compatibilidad.
              </p>
            </section>
          </aside>
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className={
                              cardStyles.compatibility
                            }
                          >
                            <span
                              className={
                                cardStyles.compatibilityText
                              }
                            >
                              {
